...
export default function Home() {
  return (
    <main className="min-h-screen bg-black text-white selection:bg-red-500 selection:text-white">
      ...
      <div className="relative overflow-hidden py-12 md:py-20 lg:py-32">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-4 md:mb-6">
      ...
      <div className="container mx-auto px-2 md:px-4 pb-32 max-w-4xl relative z-10">
        <RegistrationForm />
      </div>
    </main>
  );
